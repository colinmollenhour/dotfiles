...
> **Agent hosts:** Prefer the `megamind` agent when available (Claude Code subagent, or `grok --agent megamind` after `install.sh --agents`).
> **Skill hosts:** Tools without agents should load this skill and follow it as the full system procedure.
