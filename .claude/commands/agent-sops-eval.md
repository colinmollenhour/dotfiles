---
description: Conversational evaluation framework for AI agents using Strands Evals SDK - plan evaluations, generate test data, execute evaluations, and analyze results
---
