---
description: Guide code implementation using TDD principles with Explore, Plan, Code, Commit workflow - acts as Technical Implementation Partner and TDD Coach
---
