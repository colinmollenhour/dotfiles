...
argument-hint: "[objective|file|issue-url] [--roborev] [--dry-run] [--agents pi|omp|claude|grok|agy]"
when_to_use: "Autonomous end-to-end task delivery, complex plan execution, spec implementation, multi-agent MBOT/MBOD workflows."
---
