...
When running under OpenCode, remain the primary orchestrator session. Delegate bounded subtasks using OpenCode subagents (`mode: subagent`) or `run-opencode.ts`.
