...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="colin"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/colin/.mail/inbox/new"
	
	## mbox
	# Path to the mbox to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/mail/colin"
	
	## mailcheck
	# Optional path to mailcheckrc
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/colin/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/colin/.now_playing.log"
...
# tmux_continuum_save.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_CONTINUUM_PATH="/home/colin/.tmux/plugins//tmux-continuum"
# }
